// VERSION: v1.0.0
// beta: true = not yet owner-verified. Verified: Portuguese, Norwegian only.
export const AVAILABLE_LANGUAGES = [
  ...
  { code: "en", label: "English",    nativeLabel: "English",     short: "EN", ttsCode: "en-US", isRTL: false, beta: true  },
